...
App::App() : view(new View), model(new Model), viewmodel(new ViewModel)
{
    ...
    view->get_wstore()->set_buy_atk_command(viewmodel->get_buy_atk_command());
    view->get_wstore()->set_buy_def_command(viewmodel->get_buy_def_command());
    view->get_wstore()->set_buy_hp_command(viewmodel->get_buy_hp_command());
